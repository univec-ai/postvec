...
| **postvec-server** | Business Source License 1.1 | Development, testing, CI, staging, teaching, research; personal, noncommercial production use; one 30-day production evaluation per organization, including its affiliates under common control | Production use by an organization: [postvec Pro](https://univec.ai). Hosting or embedding for third parties: platform/OEM agreement |
