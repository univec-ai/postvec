...
mod tests {
    ...
    fn fetch_aggregates_across_nodes_last_configured_wins() {
        ...
        let report =
            crate::runtime::block_on(fetch_models_report(&endpoints, Duration::from_secs(5)))
                .unwrap();
    ...
    fn fetch_with_all_nodes_dead_errors() {
        ...
        let res = crate::runtime::block_on(fetch_models_report(&endpoints, Duration::from_secs(5)));
    ...
    fn http_error_status_is_transport_and_partial() {
        ...
        let res = crate::runtime::block_on(fetch_models_report(&only_bad, Duration::from_secs(5)));
        match res {
